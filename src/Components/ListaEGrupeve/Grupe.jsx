...
// Krejt Grupi1, Grupi2, Grupi3, Grupi4 të eksportuara ketu poshtë
export const Grupi1 = () => {
  return (
    <div className="container mt-4">
      <h2>Grupi 1</h2>
      <p>Kjo është faqja për Grupi 1.</p>
    </div>
  );
};
...
export const Grupi2 = () => {
  return (
    <div className="container mt-4">
      <h2>Grupi 2</h2>
      <p>Kjo është faqja për Grupi 2.</p>
    </div>
  );
};
...
export const Grupi3 = () => {
  return (
    <div className="container mt-4">
      <h2>Grupi 3</h2>
      <p>Kjo është faqja për Grupi 3.</p>
    </div>
  );
};
...
export const Grupi4 = () => {
  return (
    <div className="container mt-4">
      <h2>Grupi 4</h2>
      <p>Kjo është faqja për Grupi 4.</p>
    </div>
  );
};
